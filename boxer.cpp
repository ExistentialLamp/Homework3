...
void boxer(){
    ...
    int thickness;
    //Informs user of exit case
    cout << "Type 'ExIt' and '4' for the word and thickness to exit the program" << endl;
    while(true) {
        cout << "Type a word or phrase" << endl;
        cin >> boxedString;
        ...
        cout << endl;
        if(boxedString == "ExIt" && thickness == 4) {
            break;
        }
        ...
        for (int i = 0; i < height; i++) {
            ...
            if (i < thickness || i >= height - thickness) {
                ...
                cout << boxLine.substr(0, thickness) << boxSpaceChar << boxedString << boxSpaceChar
                     << boxLine.substr(0, thickness);
            }
